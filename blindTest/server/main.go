...
func main() {
	...
	http.HandleFunc("/ws/start/", handleStartBlindTest)
...
func handleRoomPage(w http.ResponseWriter, r *http.Request) {
	...
	data := map[string]any{
		...
		"Description": "Choisis une des playlists !",
	}
...
func handleStartBlindTest(w http.ResponseWriter, r *http.Request) {
	...
	rObj := rooms.Room{
		...
		PlayerIDs: playerIDs,
		MaxRounds: 1,
		Config:    map[string]any{"playlist": "Rock"},
	}
